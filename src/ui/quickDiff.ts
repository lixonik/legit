 ...
 * a SourceControl -- jegit's UI is the bottom panel, and registering an SCM
 * provider only added a confusing empty "jegit" entry to the Source Control view.
 */
